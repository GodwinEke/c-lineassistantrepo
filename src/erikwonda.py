...
def main(args):
    ...
    if len(args) <= 1:
        sys.exit('\nHello, please specify what you want me to do. Thank you :)\n')
        

    if len(args) > 2:
        sys.exit("\nHey, there. Sorry, I can do one action at a time: python main.py [KEYWORD]. Type 'help' to know what I can do.\n")
